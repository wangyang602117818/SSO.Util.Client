...
namespace SSO.Util.Client
{
    public class MessageCenterService
    {
        ...
        /// <returns></returns>
        public ServiceModel<string> InsertLog(string from, string controller, string action, string route, string querystring, string content, string userId, string userName, string userHost, string userAgent, int time = 0)
        {
