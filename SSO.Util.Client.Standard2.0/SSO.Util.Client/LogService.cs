...
namespace SSO.Util.Client
{
    ...
    public class LogService
    {
        ...
        public ServiceModel<List<LogModel>> GetList(string from = null, string controller = null, string action = null, DateTime? startTime = null, DateTime? endTime = null, string userId = null, string userName = null, Dictionary<string, string> sorts = null, bool? exception = null, int pageIndex = 1, int pageSize = 10)
        {
            ...
            var result = requestHelper.Post(baseUrl.TrimEnd('/') + "/log/getlist?", logModel, null); ;
        ...
        {
            var result = requestHelper.Get(baseUrl.TrimEnd('/') + "/log/getbyid/" + id, null);
        ...
        {
            var result = requestHelper.Get(baseUrl.TrimEnd('/') + "/log/recordbyday?last=" + last, null);
        ...
        {
            var result = requestHelper.Get(baseUrl.TrimEnd('/') + "/log/getfromlist", null);
        ...
        {
            var result = requestHelper.Get(baseUrl.TrimEnd('/') + "/log/getcontrollersbyfrom?from=" + from, null);
        ...
        {
            var result = requestHelper.Get(baseUrl.TrimEnd('/') + "/log/getactionsbycontroller?from=" + from + "&controllerName=" + controllerName, null);
        ...
        {
            var result = requestHelper.Get(baseUrl.TrimEnd('/') + "/log/getoperations", null);
